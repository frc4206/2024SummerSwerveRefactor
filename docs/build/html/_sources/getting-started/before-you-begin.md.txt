...
```{important}
_battleaid_ is targeted towards _intermediate_ and _above_ users.
```

## Requirements

```{note}
- _battleaid_ is only available for Java projects.
...
In general, a user will benefit the most from _battleaid_ if they have experience with CLIs.  This can not be stressed enough.  Unlocking the full potential of your computer is inevitably linked with a solid grip on the terminal.  
